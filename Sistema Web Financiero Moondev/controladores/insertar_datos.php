...
$object->registrar_venta($usuario,"Proyecto",
...
#fin
 */
#mandamos el iva de este proyecto 
include 'iva.php';
$control_iva= new iva();
$control_iva->registro_iva($usuario,$iva_proyecto,$fecha);
#fin

#mandamos la renta de este proyecto
include 'renta.php';
$control_renta= new renta();
$info =$control_renta->registro_renta($usuario,$renta_proyecto,$fecha);
...
#motivo de incremento
 ...
 $result=$object->incremento_capital($usuario,$descrip_incremento,$motivo,$cantidad,$fecha);
 ...
 if ($result=="Hecho") {
  ...
  <br>
     <div class=container>
   <div class=jumbotron style='border-radius:20px;'>
       <center><h4 style='font-family:Arial,Helvetica,sans-serif;' class='teal-text text-darken-1'><b>Algo Salio Mal Lo Siento </b></h4>
      <a href=../vistas/ingreso.php>
     <img src='../vistas/imagenes/iconos/c.ico' class='responsive-img' width=80px height=80px> 
     </a></center>
   </div>

...
<ul id="slide-out" class="sidenav">
  <li>
    ...
    <span class="black-text name"><?php echo $_SESSION["nombre"]; ?></span>
...
<div class="container-fluid" >
    ...
    <div class="jumbotron-fluid" style="width: 300px">
      ...
      <?php
      echo "<input type=hidden id=valor value='".$_SESSION["cargo"]."' >";
      ?>
    ...
    <tr>
    <th colspan="2">
    <button class="waves-effect amber accent-2 btn-large col-lg-12 " onclick='mostrar_pagos()'>Mostrar</button>
    </th>
    </tr>
    </table>
    </div>
   ...
   <br>
  <center>
  <div class="jumbotron"  style="margin:3px; width:800px; border-radius:15px;">

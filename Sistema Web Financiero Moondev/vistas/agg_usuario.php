...
<div class='jumbotron col-8' align=left style='position:relative;'>
<div style='position:absolute; top:1%; margin-top:1% '>
<img src="imagenes/iconos/a.ico" class="responsive-img" width=35px height=35px onclick=mostrar_usuario()>
</div>
...
<center><input type="reset" value="Limpiar Campos"  class="btn btn-danger light-black" >



<input type="submit" class="btn btn-danger light-green" value="Registrar Usuario"></center>

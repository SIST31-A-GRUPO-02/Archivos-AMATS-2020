...
1,000 viáticos
-----------
4,000 de ganancia neta.
A esta ganancia neta se le aplica el 25% de Renta y eso es lo que se entrega 
a hacienda y debe salir en el reporte anual
*/
...
<th  colspan="2" class=" white teal-text text-darken-4" ><b>Pagos</b></th>
...
<tr >
    ...
    <td class="white">Ganancias Sin Iva :</td>
...
<tr>
    ...
    <td class="white">Costos De Proyectos :</td>
...
<tr>
    ...
    <td class="white">Pago De Viaticos :</td>
...
<tr>
    ...
    <td class="white">Ganancia Neta :</td>
...
<tr>
    ...
    <td class="white">Pago A Hacienda :</td>
...
<tr>
    ...
    <td class="amber accent-1">Capital :</td>

    <td class="table-active amber accent-2"><b>$ <?php echo $dineroFinal;?></b></td>
...
<?php 
    ...
    echo"<h1>No Puedes Acceder Aqui</h1>";
}

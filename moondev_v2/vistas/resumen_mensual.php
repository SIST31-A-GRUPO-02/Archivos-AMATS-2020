...
<th colspan="2"> <button class="waves-effect  amber accent-3 btn-large col-lg-12 " onclick='mostrar_datos()'>
...
<div class="container col-lg-10" id=cuerpo4 style="overflow: scroll; height:500px;
...
<hr>
  ...
  <div class="container col-auto " id=cuerpo style="overflow: scroll; height:500px;
  ...
  <div class="container col-auto" id=cuerpo2 style="overflow: scroll; height:500px;
  ...
  <div class="container col-auto" id=cuerpo3 style="overflow: scroll; height:500px;
 ...
 <div class="container col-auto" id=cuerpo5 style="overflow: scroll; height:500px;

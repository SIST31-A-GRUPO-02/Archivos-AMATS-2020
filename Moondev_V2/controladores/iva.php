...
function registro_iva($usuario,$iva_del_proyecto,$iva_de_compras,$fecha)
{
require_once '../modelo/crud.php';
 $object= new crud();
 require_once  'funciones_ayuda.php';
 $obj2= new ayudas();
    $sql="INSERT INTO iva_mensual (id_user,iva_proyecto,iva_compra,fecha)
    VALUES($usuario,$iva_del_proyecto,$iva_de_compras,'$fecha')";

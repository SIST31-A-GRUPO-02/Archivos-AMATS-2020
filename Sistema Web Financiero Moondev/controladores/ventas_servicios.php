...
class ventas 
{
    ...
    function porcentaje_ganancias($precio , $porcent_ganancia)
    {
        ...
        include_once("funciones_ayuda.php"); 
        $object= new ayudas;
        
        
        $porcent_ganancia=($precio * $porcent_ganancia)/100;
        $porcent_ganancia=$object->redondear_dos_decimal($porcent_ganancia);
...
{   
    ...
    $renta_proyecto=$object->redondear_dos_decimal($renta_proyecto);
...
{   
 /*    require ("funciones_ayuda.php");  */
    ...
    $object= new ayudas;
        ...
        $precio_sin_iva=$object->redondear_dos_decimal($precio_sin_iva);
...
$object= new ayudas;
    ...
    $iva_proyecto=$object->redondear_dos_decimal($iva_proyecto);
